...
MODULES = [
    ...
    ("playground/static/js/chat.js", "对话状态", "管理模型/Skill 选择、Codex session、断线重连轮询、日志、Markdown 和消息"),
    ...
    ("playground/tests/test_run_registry.py", "后端回归测试", "验证运行记录隔离、清理、持久化和服务重启恢复逻辑"),
