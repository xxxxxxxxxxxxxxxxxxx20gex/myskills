...
|---|---|---|---:|---|---|
| `skills-showcase.html` | 页面外壳 | 正常 | 16,833 B | — | 保留语义化 HTML、卡片容器、详情弹窗和右侧对话区域 |
| `playground/static/styles.css` | 样式系统 | 正常 | 21,570 B | — | 负责响应式布局、卡片、对话、Git 操作反馈、日志和产物预览样式 |
...
| `playground/generate_project_status.py` | 状态文档生成器 | 正常 | 8,611 B | — | 扫描模块、配置与 Skill 目录并更新本文件 |
