...
MODULES = [
    ...
    ("playground/static/js/markdown.js", "Markdown 渲染", "安全渲染标题、表格、任务列表、引用、代码和外部链接，不执行原始 HTML"),
    ...
    ("playground/server.py", "本地 Runner", "注册原始 Skills，桥接 Codex CLI，提供运行与 AI 分析接口并执行静态资源白名单"),
